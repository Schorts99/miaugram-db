...
class Db {
  ...
  likeImage (id, callback) {
    ...
    let tasks = co.wrap(function * () {
      ...
      // The image is updated in the propertie liked that pass from false to true and the likes of the image Increase by one
  ...
  authenticate (username, password, callback) {
    ...
    let tasks = co.wrap(function * () {
      let user = null
      // Check if the user exists to authenticatebe
      try {
  ...
  getImagesByUser (userId, callback) {
    ...
    let tasks = co.wrap(function * () {
      ...
      let images = r.db(db).table('images').getAll(userId, {
        index: 'userId'
  ...
  getImagesByTag (tag, callback) {
    ...
    let tasks = co.wrap(function * () {
      ...
      let images = r.db(db).table('images').filter((img) => {
